    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="<?=site_url('admin/BlogC/save/'.$id)?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        -->
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="<?=set_value('title',$title)?>" type="text">
                            ...
                            <tr>
                                <th>作者：</th>
                                <td><input class="common-text" name="author" size="50" value="<?=set_value('author',$author)?>" type="text">
                            ...
                            -->    
                             <tr>
                                ...
                                <td><input name="logo" id="" type="file"><span style="color:red"><?php if(isset($error)){echo $error;}?></span>
                                    <?php if(!empty($logo)){?><span>（你已经上传照片，如果再次上传图片就会覆盖原图）</span><?php }?>
                                </td>
                            </tr>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><textarea name="content" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?=set_value('content',$content)?></textarea>
                            ...
                            <tr>
                                <th>是否显示：</th>
                                <td>
                                    <input  name="is_show" value="是" type="radio" <?php if($is_show == '是'){echo 'checked="checked"';}?>>是
                                    <input  name="is_show" value="否" type="radio" <?php if($is_show == '否'){echo 'checked="checked"';}?>>否
                                </td>
                            </tr>
                            <tr>
                                <th>是否推荐：</th>
                                <td>
                                    <input  name="is_res" value="是" type="radio" <?php if($is_res == '是'){echo 'checked="checked"';}?>>是
                                    <input  name="is_res" value="否" type="radio" <?php if($is_res == '否'){echo 'checked="checked"';}?>>否
                                </td>
                            </tr>
                            <tr>
                                <th></th>
